  ...
  execute: async function* (
    ...
    try {
      ...
      if (occurrences === 0) {
        ...
        const hint = loosyMatch ? ' (a trimmed version was found — check leading/trailing whitespace)' : '';
        return {
          success: false,
      ...
      if (occurrences > 1) {
        return {
          success: false,
          llmContent: `Error: oldText matches ${occurrences} times in ${filePath}. Include more surrounding context to make it unique.`,
          error: {
